            ...
            <div className={`rounded-lg shadow-2xl w-96 overflow-hidden ${
                ...
                <div className="p-5">
                    ...
                    <input
                        ...
                        className={`w-full px-4 py-2.5 border rounded-lg text-sm focus:outline-none focus:border-orange-500 transition-colors ${
                            theme === 'dark'
                ...
                <div className={`px-5 py-4 flex justify-end gap-2 ${
                    ...
                    <button className={`px-4 py-2 text-sm rounded-lg transition-colors cursor-pointer ${
                        theme === 'dark'
